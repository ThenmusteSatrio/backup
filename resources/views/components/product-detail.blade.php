                    ...
                    <div class="flex-none lg:flex">
                        ...
                        <div class="flex-auto py-2 ml-3 justify-evenly">
                            ...
                            <div class="flex space-x-3 text-sm font-medium">
                                ...
                                <button @if ($car['status'] == 'tidak tersedia') disabled @endif
                                    @click="modalDetail = !modalDetail, openFormTransaksi= true"
                                    wire:click="initializeTransaksi('{{ $car['harga'] }}', '{{ $car['nopol'] }}' )"
                                    class="py-1.5 px-9 mb-2 tracking-wider text-white bg-gray-900 rounded-lg shadow-sm md:mb-0 hover:bg-gray-800"
