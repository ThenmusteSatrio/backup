...
<div class="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5">
    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1200px">
                ...
                <div>
                    <div class="flex -mx-3">
                        <div class="w-1/2 px-3 mb-5">
                            <label for="" class="text-xs font-semibold px-1">NIK</label>
                            <div class="flex">
                                <div
                                    class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                    <i class="mdi mdi-card-account-details-outline text-gray-400 text-lg"></i>
                                </div>
                            ...
                            @error('nik')
                                <p class="text-xs text-pink-500 mb-2 font-sans">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="w-1/2 px-3 mb-5">
                    ...
                    <div class="flex -mx-3">
                        ...
                        <div class="w-full px-3 mb-5">
                            <label for="" class="text-xs font-semibold px-1">Jenis Kelamin</label>
                            <div class="flex">
                                <div
                                    class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                    <i class="mdi mdi-gender-male-female text-gray-400 text-lg"></i>
                                </div>
                                <select name="" id="" wire:model.change="jk"
                                    class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500">
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <label for="" class="text-xs font-semibold px-1">No. Telp</label>
                            <div class="flex">
                                <div
                                    class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                    <i class="mdi mdi-phone text-gray-400 text-lg"></i>
                                </div>
                                <input type="tel" wire:model="notelp"
                                    class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                    placeholder="************">
                            </div>
                            @error('notelp')
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-12">
                            ...
                            <div class="flex">
                                <div
                                    class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                    <i class="mdi mdi-map-marker text-gray-400 text-lg"></i>
                                </div>
                                <textarea wire:model="alamat" wire:keydown.enter="register"
                                    class="w-full  pt-5 align-middle -ml-10 pl-10 pr-3 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
